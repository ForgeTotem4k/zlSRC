...
public interface DBT {
  ...
  public static class DEV_BROADCAST_DEVICEINTERFACE extends Structure {
    ...
    public void read() {
      ...
      int j = (i - fieldOffset("dbcc_name")) / Native.WCHAR_SIZE;
      this.dbcc_name = new char[j];
      super.read();
    }
  ...
  public static class DEV_BROADCAST_PORT extends Structure {
    ...
    public void read() {
      int i = getPointer().getInt(0L);
      this.dbcp_name = new byte[i - fieldOffset("dbcp_name")];
      super.read();
    }
...
/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\com\sun\jna\platform\win32\DBT.class
