...
public interface Ddeml extends StdCallLibrary {
  ...
  int DdeInitialize(WinDef.DWORDByReference paramDWORDByReference, DdeCallback paramDdeCallback, int paramInt1, int paramInt2);
  
  boolean DdeUninitialize(int paramInt);
  
  HCONVLIST DdeConnectList(int paramInt, HSZ paramHSZ1, HSZ paramHSZ2, HCONVLIST paramHCONVLIST, CONVCONTEXT paramCONVCONTEXT);
  
  HCONV DdeQueryNextServer(HCONVLIST paramHCONVLIST, HCONV paramHCONV);
  
  boolean DdeDisconnectList(HCONVLIST paramHCONVLIST);
  
  HCONV DdeConnect(int paramInt, HSZ paramHSZ1, HSZ paramHSZ2, CONVCONTEXT paramCONVCONTEXT);
  
  boolean DdeDisconnect(HCONV paramHCONV);
  ...
  public static class MONHSZSTRUCT extends Structure {
    ...
    public String getStr() {
      int i = fieldOffset("str");
      return (W32APITypeMapper.DEFAULT == W32APITypeMapper.UNICODE) ? getPointer().getWideString(i) : getPointer().getString(i);
    }
  }
  ...
  public static class HSZPAIR extends Structure {
    ...
    public HSZPAIR(Ddeml.HSZ param1HSZ1, Ddeml.HSZ param1HSZ2) {
      this.service = param1HSZ1;
      this.topic = param1HSZ2;
    }
  }
...
/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\com\sun\jna\platform\win32\Ddeml.class
