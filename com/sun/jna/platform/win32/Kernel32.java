...
public interface Kernel32 extends StdCallLibrary, WinNT, Wincon {
  ...
  public static final WinDef.DWORD PROCESS_MODE_BACKGROUND_BEGIN = new WinDef.DWORD(1048576L);
  
  public static final WinDef.DWORD PROCESS_MODE_BACKGROUND_END = new WinDef.DWORD(2097152L);
  ...
  public static final int THREAD_PRIORITY_ERROR_RETURN = 2147483647;
  ...
  public static final int PF_ARM_V8_INSTRUCTIONS_AVAILABLE = 29;
  
  public static final int PF_ARM_V8_CRYPTO_INSTRUCTIONS_AVAILABLE = 30;
  
  public static final int PF_ARM_V8_CRC32_INSTRUCTIONS_AVAILABLE = 31;
  
  public static final int PF_RDTSCP_INSTRUCTION_AVAILABLE = 32;
  
  public static final int PF_RDPID_INSTRUCTION_AVAILABLE = 33;
  
  public static final int PF_ARM_V81_ATOMIC_INSTRUCTIONS_AVAILABLE = 34;
  
  public static final int PF_SSSE3_INSTRUCTIONS_AVAILABLE = 36;
  
  public static final int PF_SSE4_1_INSTRUCTIONS_AVAILABLE = 37;
  
  public static final int PF_SSE4_2_INSTRUCTIONS_AVAILABLE = 38;
  
  public static final int PF_AVX_INSTRUCTIONS_AVAILABLE = 39;
  
  public static final int PF_AVX2_INSTRUCTIONS_AVAILABLE = 40;
  
  public static final int PF_AVX512F_INSTRUCTIONS_AVAILABLE = 41;
  
  public static final int PF_ARM_V82_DP_INSTRUCTIONS_AVAILABLE = 43;
  
  public static final int PF_ARM_V83_JSCVT_INSTRUCTIONS_AVAILABLE = 44;
  
  public static final int PF_ARM_V83_LRCPC_INSTRUCTIONS_AVAILABLE = 45;
  ...
  WinNT.HANDLE OpenFileMapping(int paramInt, boolean paramBoolean, String paramString);
  ...
  WinDef.DWORD GetPriorityClass(WinNT.HANDLE paramHANDLE);
  
  boolean SetPriorityClass(WinNT.HANDLE paramHANDLE, WinDef.DWORD paramDWORD);
  
  int GetThreadPriority(WinNT.HANDLE paramHANDLE);
  
  boolean SetThreadPriority(WinNT.HANDLE paramHANDLE, int paramInt);
  
  boolean VirtualFreeEx(WinNT.HANDLE paramHANDLE, Pointer paramPointer, BaseTSD.SIZE_T paramSIZE_T, int paramInt);
  
  WinNT.HRESULT RegisterApplicationRestart(char[] paramArrayOfchar, int paramInt);
  
  WinNT.HRESULT UnregisterApplicationRestart();
  
  WinNT.HRESULT GetApplicationRestartSettings(WinNT.HANDLE paramHANDLE, char[] paramArrayOfchar, IntByReference paramIntByReference1, IntByReference paramIntByReference2);
  
  boolean VirtualLock(Pointer paramPointer, BaseTSD.SIZE_T paramSIZE_T);
  
  boolean VirtualUnlock(Pointer paramPointer, BaseTSD.SIZE_T paramSIZE_T);
  
  boolean IsProcessorFeaturePresent(int paramInt);
}


/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\com\sun\jna\platform\win32\Kernel32.class
