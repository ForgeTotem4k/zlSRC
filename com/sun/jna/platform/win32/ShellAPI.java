...
public interface ShellAPI extends StdCallLibrary {
  ...
  public static class APPBARDATA extends Structure {
    ...
    public APPBARDATA(Pointer param1Pointer) {
      super(param1Pointer);
    }
  ...
  public static class SHFILEOPSTRUCT extends Structure {
    ...
    public String encodePaths(String[] param1ArrayOfString) {
      String str = "";
      for (byte b = 0; b < param1ArrayOfString.length; b++) {
        str = str + param1ArrayOfString[b];
        str = str + "\000";
      } 
      return str + "\000";
    }
...
/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\com\sun\jna\platform\win32\ShellAPI.class
