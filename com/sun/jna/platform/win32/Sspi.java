...
public interface Sspi {
  ...
  public static class SecPkgContext_KeyInfo extends Structure {
    ...
    public synchronized String getSignatureAlgorithmName() {
      return (this.sSignatureAlgorithmName == null) ? null : (Boolean.getBoolean("w32.ascii") ? this.sSignatureAlgorithmName.getString(0L) : this.sSignatureAlgorithmName.getWideString(0L));
    }
    
    public synchronized String getEncryptAlgorithmName() {
      return (this.sEncryptAlgorithmName == null) ? null : (Boolean.getBoolean("w32.ascii") ? this.sEncryptAlgorithmName.getString(0L) : this.sEncryptAlgorithmName.getWideString(0L));
    }
  ...
  public static class SecPkgCredentials_Names extends Structure {
    ...
    public synchronized String getUserName() {
      return (this.sUserName == null) ? null : (Boolean.getBoolean("w32.ascii") ? this.sUserName.getString(0L) : this.sUserName.getWideString(0L));
    }
    
    public synchronized int free() {
      if (this.sUserName != null) {
        int i = Secur32.INSTANCE.FreeContextBuffer(this.sUserName);
        this.sUserName = null;
        return i;
      } 
      return 0;
  ...
  public static class PSecPkgInfo extends Structure {
    ...
    public Sspi.SecPkgInfo.ByReference[] toArray(int param1Int) {
      return (Sspi.SecPkgInfo.ByReference[])this.pPkgInfo.toArray(param1Int);
    }
  ...
  public static class SecBuffer extends Structure {
    ...
    public SecBuffer(int param1Int1, int param1Int2) {
      this.cbBuffer = param1Int2;
      this.pvBuffer = (Pointer)new Memory(param1Int2);
      this.BufferType = param1Int1;
    }
    
    public SecBuffer(int param1Int, byte[] param1ArrayOfbyte) {
      this.cbBuffer = param1ArrayOfbyte.length;
      this.pvBuffer = (Pointer)new Memory(param1ArrayOfbyte.length);
      this.pvBuffer.write(0L, param1ArrayOfbyte, 0, param1ArrayOfbyte.length);
      this.BufferType = param1Int;
    }
    ...
    public static class ByReference extends SecBuffer implements Structure.ByReference {
      ...
      public ByReference(int param2Int, byte[] param2ArrayOfbyte) {
        super(param2Int, param2ArrayOfbyte);
      }
    }
  }
  ...
  public static class PSecHandle extends Structure {
    ...
    public PSecHandle(Sspi.SecHandle param1SecHandle) {
      super(param1SecHandle.getPointer());
      read();
    }
...
/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\com\sun\jna\platform\win32\Sspi.class
