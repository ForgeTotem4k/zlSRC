...
public enum Win32VK {
  ...
  Win32VK(int paramInt1, int paramInt2) {
    this.code = paramInt1;
    this.introducedVersion = paramInt2;
  }
  
  public static Win32VK fromValue(int paramInt) {
    for (Win32VK win32VK : values()) {
      if (win32VK.code == paramInt)
        return win32VK; 
    } 
    throw new IllegalArgumentException(String.format("No mapping for %02x", new Object[] { Integer.valueOf(paramInt) }));
  }
}


/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\com\sun\jna\platform\win32\Win32VK.class
