...
public interface WinNT extends WinError, WinDef, WinBase, BaseTSD {
  ...
  public static class NUMA_NODE_RELATIONSHIP extends SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX {
    ...
    public void read() {
      ...
      int i = Math.max(1, this.groupCount);
      if (i != this.groupMasks.length)
        this.groupMasks = new WinNT.GROUP_AFFINITY[i]; 
      super.read();
  ...
  public static abstract class SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX extends Structure {
    ...
    public static SYSTEM_LOGICAL_PROCESSOR_INFORMATION_EX fromPointer(Pointer param1Pointer) {
      ...
      int i = param1Pointer.getInt(0L);
      switch (i) {
        case 0:
        case 3:
        case 5:
        case 7:
          pROCESSOR_RELATIONSHIP = new WinNT.PROCESSOR_RELATIONSHIP(param1Pointer);
          pROCESSOR_RELATIONSHIP.read();
          return pROCESSOR_RELATIONSHIP;
        case 1:
        case 6:
          nUMA_NODE_RELATIONSHIP = new WinNT.NUMA_NODE_RELATIONSHIP(param1Pointer);
          nUMA_NODE_RELATIONSHIP.read();
          return nUMA_NODE_RELATIONSHIP;
        case 2:
          cACHE_RELATIONSHIP = new WinNT.CACHE_RELATIONSHIP(param1Pointer);
          cACHE_RELATIONSHIP.read();
          return cACHE_RELATIONSHIP;
        case 4:
          gROUP_RELATIONSHIP = new WinNT.GROUP_RELATIONSHIP(param1Pointer);
          gROUP_RELATIONSHIP.read();
          return gROUP_RELATIONSHIP;
      } 
      WinNT.UNKNOWN_RELATIONSHIP uNKNOWN_RELATIONSHIP = new WinNT.UNKNOWN_RELATIONSHIP(param1Pointer);
      uNKNOWN_RELATIONSHIP.read();
  ...
  public static class ACCESS_DENIED_ACE extends ACCESS_ACEStructure {
    ...
    public ACCESS_DENIED_ACE(int param1Int, byte param1Byte, WinNT.PSID param1PSID) {
      super(param1Int, (byte)1, param1Byte, param1PSID);
    }
  }
  ...
  public static class ACCESS_ALLOWED_ACE extends ACCESS_ACEStructure {
    ...
    public ACCESS_ALLOWED_ACE(int param1Int, byte param1Byte, WinNT.PSID param1PSID) {
      super(param1Int, (byte)0, param1Byte, param1PSID);
    }
  }
  ...
  public static abstract class ACCESS_ACEStructure extends ACE_HEADER {
    ...
    public ACCESS_ACEStructure(int param1Int, byte param1Byte1, byte param1Byte2, WinNT.PSID param1PSID) {
      calculateSize(true);
      this.AceType = param1Byte1;
      this.AceFlags = param1Byte2;
      this.AceSize = (short)(fieldOffset("SidStart") + (param1PSID.getBytes()).length);
      this.psid = param1PSID;
      this.Mask = param1Int;
      this.SidStart = param1PSID.getPointer().getByteArray(0L, this.SidStart.length);
    ...
    public void write() {
      super.write();
      int i = fieldOffset("SidStart");
      int j = this.AceSize - fieldOffset("SidStart");
      if (this.psid != null) {
        byte[] arrayOfByte = this.psid.getBytes();
        assert arrayOfByte.length <= j;
        getPointer().write(i, arrayOfByte, 0, j);
      } 
    }
    ...
    public void read() {
      ...
      int j = this.AceSize - fieldOffset("SidStart");
      if (j > 0) {
        this.psid = new WinNT.PSID(getPointer().getByteArray(i, j));
      } else {
  ...
  public static class SECURITY_DESCRIPTOR_RELATIVE extends Structure {
    ...
    public SECURITY_DESCRIPTOR_RELATIVE(byte[] param1ArrayOfbyte) {
      super((Pointer)new Memory(param1ArrayOfbyte.length));
      getPointer().write(0L, param1ArrayOfbyte, 0, param1ArrayOfbyte.length);
      setMembers();
    }
    ...
    private final void setMembers() {
      ...
      if (this.Sacl != 0)
        this.SACL = new WinNT.ACL(getPointer().share(this.Sacl)); 
      if (this.Group != 0)
        this.GROUP = new WinNT.PSID(getPointer().share(this.Group)); 
      if (this.Owner != 0)
        this.OWNER = new WinNT.PSID(getPointer().share(this.Owner)); 
    }
  ...
  public static class PACLByReference extends com.sun.jna.ptr.ByReference {
    ...
    public void setValue(WinNT.ACL param1ACL) {
      getPointer().setPointer(0L, (param1ACL != null) ? param1ACL.getPointer() : null);
    }
    
    public WinNT.ACL getValue() {
      Pointer pointer = getPointer().getPointer(0L);
      return (pointer == null) ? null : new WinNT.ACL(pointer);
    }
  }
  ...
  public static class ACL extends Structure {
    ...
    public ACL(int param1Int) {
      useMemory((Pointer)new Memory(param1Int));
    }
    ...
    public WinNT.ACE_HEADER[] getACEs() {
      WinNT.ACE_HEADER[] arrayOfACE_HEADER = new WinNT.ACE_HEADER[this.AceCount];
      Pointer pointer = getPointer();
      int i = size();
      for (byte b = 0; b < this.AceCount; b++) {
        Pointer pointer1 = pointer.share(i);
        byte b1 = pointer1.getByte(0L);
        switch (b1) {
          case 0:
            arrayOfACE_HEADER[b] = new WinNT.ACCESS_ALLOWED_ACE(pointer1);
            break;
          case 1:
            arrayOfACE_HEADER[b] = new WinNT.ACCESS_DENIED_ACE(pointer1);
            break;
          default:
            arrayOfACE_HEADER[b] = new WinNT.ACE_HEADER(pointer1);
            break;
        } 
        i += (arrayOfACE_HEADER[b]).AceSize;
      } 
  ...
  public static class SECURITY_DESCRIPTOR extends Structure {
    ...
    public SECURITY_DESCRIPTOR(byte[] param1ArrayOfbyte) {
      ...
      useMemory((Pointer)new Memory(param1ArrayOfbyte.length));
    }
  ...
  public static class HANDLEByReference extends com.sun.jna.ptr.ByReference {
    ...
    public HANDLEByReference(WinNT.HANDLE param1HANDLE) {
      super(Native.POINTER_SIZE);
      setValue(param1HANDLE);
    }
    
    public void setValue(WinNT.HANDLE param1HANDLE) {
      getPointer().setPointer(0L, (param1HANDLE != null) ? param1HANDLE.getPointer() : null);
    }
  ...
  public static class HANDLE extends PointerType {
    ...
    public HANDLE(Pointer param1Pointer) {
      setPointer(param1Pointer);
      this.immutable = true;
    }
    
    public Object fromNative(Object param1Object, FromNativeContext param1FromNativeContext) {
      Object object = super.fromNative(param1Object, param1FromNativeContext);
      return WinBase.INVALID_HANDLE_VALUE.equals(object) ? WinBase.INVALID_HANDLE_VALUE : object;
    }
    
    public void setPointer(Pointer param1Pointer) {
      if (this.immutable)
        throw new UnsupportedOperationException("immutable reference"); 
      super.setPointer(param1Pointer);
    }
  ...
  public static class LARGE_INTEGER extends Structure implements Comparable<LARGE_INTEGER> {
    ...
    public int compareTo(LARGE_INTEGER param1LARGE_INTEGER) {
      return compare(this, param1LARGE_INTEGER);
    }
    ...
    public static int compare(LARGE_INTEGER param1LARGE_INTEGER1, LARGE_INTEGER param1LARGE_INTEGER2) {
      return (param1LARGE_INTEGER1 == param1LARGE_INTEGER2) ? 0 : ((param1LARGE_INTEGER1 == null) ? 1 : ((param1LARGE_INTEGER2 == null) ? -1 : IntegerType.compare(param1LARGE_INTEGER1.getValue(), param1LARGE_INTEGER2.getValue())));
    }
    
    public static int compare(LARGE_INTEGER param1LARGE_INTEGER, long param1Long) {
      return (param1LARGE_INTEGER == null) ? 1 : IntegerType.compare(param1LARGE_INTEGER.getValue(), param1Long);
    }
    ...
    public static class UNION extends Union {
      ...
      public UNION(long param2Long) {
        this.value = param2Long;
        this.lh = new WinNT.LARGE_INTEGER.LowHigh(param2Long);
      }
    ...
    public static class LowHigh extends Structure {
      ...
      public LowHigh(long param2Long) {
        this(new WinDef.DWORD(param2Long & 0xFFFFFFFFL), new WinDef.DWORD(param2Long >> 32L & 0xFFFFFFFFL));
      }
      
      public LowHigh(WinDef.DWORD param2DWORD1, WinDef.DWORD param2DWORD2) {
        this.LowPart = param2DWORD1;
        this.HighPart = param2DWORD2;
      }
      
      public long longValue() {
        long l1 = this.LowPart.longValue();
        long l2 = this.HighPart.longValue();
        return l2 << 32L & 0xFFFFFFFF00000000L | l1 & 0xFFFFFFFFL;
      }
  ...
  public static class FILE_NOTIFY_INFORMATION extends Structure {
    ...
    public FILE_NOTIFY_INFORMATION(int param1Int) {
      if (param1Int < size())
        throw new IllegalArgumentException("Size must greater than " + size() + ", requested " + param1Int); 
      allocateMemory(param1Int);
    }
  ...
  public static class TOKEN_PRIVILEGES extends Structure {
    ...
    public TOKEN_PRIVILEGES(int param1Int) {
      this.PrivilegeCount = new WinDef.DWORD(param1Int);
      this.Privileges = new WinNT.LUID_AND_ATTRIBUTES[param1Int];
    }
    ...
    public TOKEN_PRIVILEGES(Pointer param1Pointer) {
      ...
      this.Privileges = new WinNT.LUID_AND_ATTRIBUTES[i];
      read();
    }
  }
  ...
  public static class PSIDByReference extends com.sun.jna.ptr.ByReference {
    ...
    public void setValue(WinNT.PSID param1PSID) {
      getPointer().setPointer(0L, (param1PSID != null) ? param1PSID.getPointer() : null);
    }
    
    public WinNT.PSID getValue() {
      Pointer pointer = getPointer().getPointer(0L);
      return (pointer == null) ? null : new WinNT.PSID(pointer);
    }
  }
  ...
  public static class PSID extends Structure {
    ...
    public byte[] getBytes() {
      int i = Advapi32.INSTANCE.GetLengthSid(this);
      return getPointer().getByteArray(0L, i);
    }
  ...
  public static class LUID_AND_ATTRIBUTES extends Structure {
    ...
    public LUID_AND_ATTRIBUTES(WinNT.LUID param1LUID, WinDef.DWORD param1DWORD) {
      this.Luid = param1LUID;
      this.Attributes = param1DWORD;
    }
  }
...
/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\com\sun\jna\platform\win32\WinNT.class
