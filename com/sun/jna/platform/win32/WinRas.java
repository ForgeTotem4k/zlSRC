...
public interface WinRas {
  ...
  public static class RASENTRY extends Structure {
    ...
    public RASENTRY(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  ...
  public static class RASIPADDR extends Structure {
    ...
    public RASIPADDR(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  }
  ...
  public static class RASCREDENTIALS extends Structure {
    ...
    public RASCREDENTIALS(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  ...
  public static class RASCONNSTATUS extends Structure {
    ...
    public RASCONNSTATUS(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  }
  ...
  public static class RASTUNNELENDPOINT extends Structure {
    ...
    public RASTUNNELENDPOINT(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  ...
  public static class RASPPPIP extends Structure {
    ...
    public RASPPPIP(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  ...
  public static class RASIPV6ADDR extends Structure {
    ...
    public RASIPV6ADDR(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  }
  ...
  public static class RASIPV4ADDR extends Structure {
    ...
    public RASIPV4ADDR(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  }
  ...
  public static class RAS_STATS extends Structure {
    ...
    public RAS_STATS(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  }
  ...
  public static class RASCONN extends Structure {
    ...
    public RASCONN(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  ...
  public static class RASDIALPARAMS extends Structure {
    ...
    public RASDIALPARAMS(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  ...
  public static class RASDIALEXTENSIONS extends Structure {
    ...
    public RASDIALEXTENSIONS(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  ...
  public static class RASDEVSPECIFICINFO extends Structure {
    ...
    public RASDEVSPECIFICINFO(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
    
    public RASDEVSPECIFICINFO(byte[] param1ArrayOfbyte) {
      this.pbDevSpecificInfo = (Pointer)new Memory(param1ArrayOfbyte.length);
      this.pbDevSpecificInfo.write(0L, param1ArrayOfbyte, 0, param1ArrayOfbyte.length);
      this.dwSize = param1ArrayOfbyte.length;
      allocateMemory();
    }
    
    public RASDEVSPECIFICINFO(String param1String) {
  ...
  public static class RASEAPINFO extends Structure {
    ...
    public RASEAPINFO(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
    
    public RASEAPINFO(byte[] param1ArrayOfbyte) {
      this.pbEapInfo = (Pointer)new Memory(param1ArrayOfbyte.length);
      this.pbEapInfo.write(0L, param1ArrayOfbyte, 0, param1ArrayOfbyte.length);
      this.dwSizeofEapInfo = param1ArrayOfbyte.length;
      allocateMemory();
    }
    
    public RASEAPINFO(String param1String) {
      this(Native.toByteArray(param1String));
    }
...
/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\com\sun\jna\platform\win32\WinRas.class
