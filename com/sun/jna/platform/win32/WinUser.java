...
public interface WinUser extends WinDef {
  ...
  HPOWERNOTIFY RegisterPowerSettingNotification(WinNT.HANDLE paramHANDLE, Guid.GUID paramGUID, int paramInt);
  
  WinDef.BOOL UnregisterPowerSettingNotification(HPOWERNOTIFY paramHPOWERNOTIFY);
  
  @FieldOrder({"PowerSetting", "DataLength", "Data"})
  public static class POWERBROADCAST_SETTING extends Structure {
    ...
    public POWERBROADCAST_SETTING(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
    
    public final void read() {
      this.Data = new byte[getPointer().getInt(fieldOffset("DataLength"))];
      super.read();
    }
  }
  
  public static class HPOWERNOTIFY extends WinDef.PVOID {
    public HPOWERNOTIFY() {}
    
    public HPOWERNOTIFY(Pointer param1Pointer) {
      super(param1Pointer);
    }
  }
  ...
  public static class RAWINPUTDEVICELIST extends Structure {
    ...
    public RAWINPUTDEVICELIST(Pointer param1Pointer) {
      super(param1Pointer);
    }
  ...
  public static interface MONITORENUMPROC extends StdCallLibrary.StdCallCallback {
  ...
  public static class HMONITOR extends WinNT.HANDLE {
    ...
    public HMONITOR(Pointer param1Pointer) {
      super(param1Pointer);
    }
  }
  
  public static interface WindowProc extends StdCallLibrary.StdCallCallback {
  ...
  public static class WNDCLASSEX extends Structure {
    ...
    public WNDCLASSEX(Pointer param1Pointer) {
  ...
  public static class MOUSEINPUT extends Structure {
    ...
    public MOUSEINPUT(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  ...
  public static class KEYBDINPUT extends Structure {
    ...
    public KEYBDINPUT(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  ...
  public static class INPUT extends Structure {
    ...
    public INPUT(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
    ...
    public static class INPUT_UNION extends Union {
      ...
      public INPUT_UNION(Pointer param2Pointer) {
        super(param2Pointer);
        read();
      }
    }
  ...
  public static class HARDWAREINPUT extends Structure {
    ...
    public HARDWAREINPUT(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  ...
  public static class CWPSTRUCT extends Structure {
    ...
    public CWPSTRUCT(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  }
  ...
  public static interface LowLevelMouseProc extends HOOKPROC {
    WinDef.LRESULT callback(int param1Int, WinDef.WPARAM param1WPARAM, WinUser.MSLLHOOKSTRUCT param1MSLLHOOKSTRUCT);
  }
  ...
  public static class COPYDATASTRUCT extends Structure {
    ...
    public COPYDATASTRUCT(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  }
  ...
  public static class HDEVNOTIFY extends WinDef.PVOID {
    ...
    public HDEVNOTIFY(Pointer param1Pointer) {
      super(param1Pointer);
    }
  }
}
...
/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\com\sun\jna\platform\win32\WinUser.class
