...
public interface Wincon {
  ...
  public static class MOUSE_EVENT_RECORD extends Structure {
    ...
    public String toString() {
      return String.format("MOUSE_EVENT_RECORD(%s,%s,%s,%s)", new Object[] { this.dwMousePosition, Integer.valueOf(this.dwButtonState), Integer.valueOf(this.dwControlKeyState), Integer.valueOf(this.dwEventFlags) });
    }
  }
  ...
  public static class KEY_EVENT_RECORD extends Structure {
    ...
    public String toString() {
      return String.format("KEY_EVENT_RECORD(%s,%s,%s,%s,%s,%s)", new Object[] { Boolean.valueOf(this.bKeyDown), Short.valueOf(this.wRepeatCount), Short.valueOf(this.wVirtualKeyCode), Short.valueOf(this.wVirtualKeyCode), Short.valueOf(this.wVirtualScanCode), Character.valueOf(this.uChar), Integer.valueOf(this.dwControlKeyState) });
    }
  }
  ...
  public static class SMALL_RECT extends Structure {
    ...
    public String toString() {
      return String.format("SMALL_RECT(%s,%s)(%s,%s)", new Object[] { Short.valueOf(this.Left), Short.valueOf(this.Top), Short.valueOf(this.Right), Short.valueOf(this.Bottom) });
    }
  }
  ...
  public static class COORD extends Structure {
    ...
    public String toString() {
      return String.format("COORD(%s,%s)", new Object[] { Short.valueOf(this.X), Short.valueOf(this.Y) });
    }
  }
}


/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\com\sun\jna\platform\win32\Wincon.class
