...
public interface Winsvc {
  ...
  public static class SERVICE_STATUS_HANDLE extends WinNT.HANDLE {
    ...
    public SERVICE_STATUS_HANDLE(Pointer param1Pointer) {
      super(param1Pointer);
    }
  }
  ...
  public static interface HandlerEx extends StdCallLibrary.StdCallCallback {
    int callback(int param1Int1, int param1Int2, Pointer param1Pointer1, Pointer param1Pointer2);
  }
  
  public static interface Handler extends StdCallLibrary.StdCallCallback {
    void callback(int param1Int);
  }
  
  public static interface SERVICE_MAIN_FUNCTION extends StdCallLibrary.StdCallCallback {
  ...
  public static class SERVICE_FAILURE_ACTIONS_FLAG extends ChangeServiceConfig2Info {
    ...
    public SERVICE_FAILURE_ACTIONS_FLAG(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  }
  ...
  public static class SERVICE_FAILURE_ACTIONS extends ChangeServiceConfig2Info {
    ...
    public SERVICE_FAILURE_ACTIONS(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  ...
  public static abstract class ChangeServiceConfig2Info extends Structure {
    ...
    public ChangeServiceConfig2Info(Pointer param1Pointer) {
      super(param1Pointer, 0, Boolean.getBoolean("w32.ascii") ? W32APITypeMapper.ASCII : W32APITypeMapper.UNICODE);
    }
  }
  ...
  public static class SERVICE_STATUS_PROCESS extends Structure {
    ...
    public SERVICE_STATUS_PROCESS(int param1Int) {
...
/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\com\sun\jna\platform\win32\Winsvc.class
