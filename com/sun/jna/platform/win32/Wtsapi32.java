...
public interface Wtsapi32 extends StdCallLibrary {
  ...
  public static class WTS_PROCESS_INFO_EX extends Structure {
    ...
    public WTS_PROCESS_INFO_EX(Pointer param1Pointer) {
  ...
  public static class WTSINFO extends Structure {
    ...
    public WTSINFO(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
    ...
    private String getStringAtOffset(int param1Int) {
      return (CHAR_WIDTH == 1) ? getPointer().getString(param1Int) : getPointer().getWideString(param1Int);
    }
  }
  ...
  public static class WTS_CLIENT_ADDRESS extends Structure {
    ...
    public WTS_CLIENT_ADDRESS(Pointer param1Pointer) {
      super(param1Pointer);
      read();
    }
  }
  ...
  public static class WTS_SESSION_INFO extends Structure {
    ...
    public WTS_SESSION_INFO(Pointer param1Pointer) {
      super(param1Pointer, 0, W32APITypeMapper.DEFAULT);
      read();
    }
  }
...
/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\com\sun\jna\platform\win32\Wtsapi32.class
