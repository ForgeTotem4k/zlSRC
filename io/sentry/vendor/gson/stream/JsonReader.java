...
public class JsonReader implements Closeable {
  ...
  private int peekKeyword() throws IOException {
    ...
    for (byte b2 = 1; b2 < i; b2++) {
      ...
      if (c != str1.charAt(b2) && c != str2.charAt(b2))
        return 0; 
    } 
  ...
  private int peekNumber() throws IOException {
    ...
    if (b1 == 2 && k != 0 && (l != Long.MIN_VALUE || bool) && (l != 0L || false == bool)) {
  ...
  private String nextUnquotedValue() throws IOException {
    ...
    String str = (null == stringBuilder) ? new String(this.buffer, this.pos, b) : stringBuilder.append(this.buffer, this.pos, b).toString();
    this.pos += b;
    return str;
  }
  ...
  private void consumeNonExecutePrefix() throws IOException {
    ...
    if (i + 5 > this.limit && !fillBuffer(5))
      return; 
    char[] arrayOfChar = this.buffer;
    if (arrayOfChar[i] != ')' || arrayOfChar[i + 1] != ']' || arrayOfChar[i + 2] != '}' || arrayOfChar[i + 3] != '\'' || arrayOfChar[i + 4] != '\n')
      return; 
    this.pos += 5;
  }
}
...
/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\io\sentry\vendor\gson\stream\JsonReader.class
