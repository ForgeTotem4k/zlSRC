...
public final class MessageFormatter {
  ...
  public static final String basicArrayFormat(String paramString, Object[] paramArrayOfObject) {
    FormattingTuple formattingTuple = arrayFormat(paramString, paramArrayOfObject, null);
    return formattingTuple.getMessage();
  }
  
  public static String basicArrayFormat(NormalizedParameters paramNormalizedParameters) {
    return basicArrayFormat(paramNormalizedParameters.getMessage(), paramNormalizedParameters.getArguments());
  }
    ...
    for (byte b = 0; b < paramArrayOfObject.length; b++) {
      ...
      if (isEscapedDelimeter(paramString, j)) {
        if (!isDoubleEscaped(paramString, j)) {
          ...
          stringBuilder.append(paramString, i, j - 1);
          deeplyAppendParameter(stringBuilder, paramArrayOfObject[b], (Map)new HashMap<>());
          i = j + 2;
        } 
      } else {
  ...
  private static void safeObjectAppend(StringBuilder paramStringBuilder, Object paramObject) {
    try {
      ...
      Reporter.error("Failed toString() invocation on an object of type [" + paramObject.getClass().getName() + "]", throwable);
  ...
  public static Throwable getThrowableCandidate(Object[] paramArrayOfObject) {
    return NormalizedParameters.getThrowableCandidate(paramArrayOfObject);
  }
  
  public static Object[] trimmedCopy(Object[] paramArrayOfObject) {
    return NormalizedParameters.trimmedCopy(paramArrayOfObject);
  }
}


/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\org\slf4j\helpers\MessageFormatter.class
