  ...
  public static List<SoundCard> getSoundCards() {
    ...
    for (String str1 : ExecutingCommand.runNative("lshal")) {
      ...
      if (!str.isEmpty() && !str1.isEmpty()) {
        if (str1.contains("info.solaris.driver =") && "audio810".equals(ParseUtil.getSingleQuoteStringValue(str1))) {
          arrayList.add(str);
          continue;
        } 
    ...
    ArrayList<SolarisSoundCard> arrayList1 = new ArrayList();
    for (String str1 : arrayList)
      arrayList1.add(new SolarisSoundCard((String)hashMap2.get(str1) + " " + "audio810", (String)hashMap1.get(str1) + " " + (String)hashMap2.get(str1), (String)hashMap2.get(str1))); 
    return (List)arrayList1;
  }
}


/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\oshi\hardware\platfor\\unix\solaris\SolarisSoundCard.class
