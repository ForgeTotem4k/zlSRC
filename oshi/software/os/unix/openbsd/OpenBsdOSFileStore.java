...
public class OpenBsdOSFileStore extends AbstractOSFileStore {
  ...
  public OpenBsdOSFileStore(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8, String paramString9, long paramLong1, long paramLong2, long paramLong3, long paramLong4, long paramLong5) {
  ...
  public boolean updateAttributes() {
    for (OSFileStore oSFileStore : OpenBsdFileSystem.getFileStoreMatching(getName())) {
      if (getName().equals(oSFileStore.getName()) && getVolume().equals(oSFileStore.getVolume()) && getMount().equals(oSFileStore.getMount())) {
...
/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\oshi\software\o\\unix\openbsd\OpenBsdOSFileStore.class
