...
public class WindowsOSFileStore extends AbstractOSFileStore {
  ...
  public boolean updateAttributes() {
    List<OSFileStore> list = WindowsFileSystem.getLocalVolumes(getVolume());
    if (list.isEmpty()) {
      String str = (getMount().length() < 2) ? null : getMount().substring(0, 2);
      list = WindowsFileSystem.getWmiVolumes(str, false);
    } 
...
/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\oshi\software\os\windows\WindowsOSFileStore.class
