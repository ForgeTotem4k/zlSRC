...
public class SetProfileRequest extends Request<SetProfileRequestEvent> implements WebSocketRequest {
  ...
  public SetProfileRequest(ClientProfile paramClientProfile) {
    this.client = paramClientProfile.getTitle();
  }
...
/* Location:              C:\Users\forge\zLauncher\Launcher.jar!\pro\gravit\launcher\base\request\auth\SetProfileRequest.class
